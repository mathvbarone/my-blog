const startForm = {
    ...
    functions: {
        ...
        formMsg: function (message) {
            const contact = $(".contact-box");

            if (message == "loading") {
                let messageText = `<figure class="is-loading-img">
                ...
                let ajaxStatus = "loading";
            }

            if (message == "success") {
                let messageText = `<div class="success-box">
                ...
                let ajaxStatus = "success";
            }
            if (message == "error") {
                let messageText = `<div class="error-box">
                ...
                let ajaxStatus = "error";
            }

            const messageBox = `<div class="message-alert">
